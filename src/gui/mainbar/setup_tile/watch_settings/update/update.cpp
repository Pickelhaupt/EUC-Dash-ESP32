...
lv_style_t update_settings_heading_style;
...
void update_tile_setup( void ) {
    ...
    lv_style_set_bg_color( &update_settings_style, LV_OBJ_PART_MAIN, LV_COLOR_BLACK);
    ...
    lv_style_copy( &update_settings_heading_style, &update_settings_style );
    lv_style_set_text_color( &update_settings_heading_style, LV_OBJ_PART_MAIN, LV_COLOR_WHITE );
    ...
    lv_obj_align( setup_btn, update_settings_tile, LV_ALIGN_IN_TOP_RIGHT, -10, 10 );
    ...
    lv_obj_align( exit_btn, update_settings_tile, LV_ALIGN_IN_TOP_LEFT, 10, 10 );
    lv_obj_set_event_cb( exit_btn, exit_update_setup_event_cb );
    
    lv_obj_t *exit_label = lv_label_create( update_settings_tile, NULL);
    lv_obj_add_style( exit_label, LV_OBJ_PART_MAIN, &update_settings_heading_style  );
    lv_label_set_text( exit_label, "upgrade");
    lv_obj_align( exit_label, update_settings_tile, LV_ALIGN_IN_TOP_MID, 0, 15 );

    lv_obj_t *update_version_cont = lv_obj_create( update_settings_tile, NULL );
    lv_obj_set_size(update_version_cont, lv_disp_get_hor_res( NULL ) , 60);
    lv_obj_add_style( update_version_cont, LV_OBJ_PART_MAIN, &update_settings_style  );
    lv_obj_align( update_version_cont, update_settings_tile, LV_ALIGN_IN_TOP_RIGHT, 0, 55 );
