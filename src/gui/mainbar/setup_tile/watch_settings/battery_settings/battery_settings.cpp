...
lv_style_t battery_settings_heading_style;
...
void battery_settings_tile_setup( void ) {
    ...
    lv_obj_align( exit_btn, battery_settings_tile, LV_ALIGN_IN_TOP_LEFT, 10, 10 );
    lv_obj_set_event_cb( exit_btn, exit_battery_setup_event_cb );
    
    lv_obj_t *exit_label = lv_label_create( battery_settings_tile, NULL );
    lv_obj_add_style( exit_label, LV_OBJ_PART_MAIN, &battery_settings_heading_style );
    lv_label_set_text( exit_label, "energy settings");
    lv_obj_align( exit_label, battery_settings_tile, LV_ALIGN_IN_TOP_MID, 0, 15 );
    ...
    lv_obj_align( battery_silence_wakeup_switch_cont, battery_settings_tile, LV_ALIGN_IN_TOP_RIGHT, 0, 55 );
    ...
    lv_obj_add_style( battery_silence_wakeup_switch, LV_SWITCH_PART_KNOB, mainbar_get_knob_style() );
    ...
    lv_obj_align( battery_setup_label_cont, battery_silence_wakeup_switch_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 10 );
    lv_obj_t *battery_setup_label = lv_label_create( battery_setup_label_cont, NULL);
    lv_obj_add_style( battery_setup_label, LV_OBJ_PART_MAIN, &battery_settings_heading_style  );
    lv_label_set_text( battery_setup_label, "experimental functions");
    lv_obj_align( battery_setup_label, battery_setup_label_cont, LV_ALIGN_CENTER, 0, 0 );
    ...
    lv_obj_add_style( battery_percent_switch, LV_SWITCH_PART_KNOB, mainbar_get_knob_style() );
    ...
    lv_obj_add_style( battery_experimental_switch, LV_SWITCH_PART_KNOB, mainbar_get_knob_style() );
    ...
    lv_obj_add_style( battery_high_voltage_switch, LV_SWITCH_PART_KNOB, mainbar_get_knob_style() );
