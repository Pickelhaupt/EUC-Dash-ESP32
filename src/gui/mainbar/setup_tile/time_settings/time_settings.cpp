...
lv_style_t time_settings_heading_style;
...
void time_settings_tile_setup( void ) {
    ...
    lv_style_copy( &time_settings_heading_style, &time_settings_style );
    lv_style_set_text_color( &time_settings_heading_style, LV_OBJ_PART_MAIN, LV_COLOR_WHITE );
    ...
    lv_obj_align( exit_btn, time_settings_tile, LV_ALIGN_IN_TOP_LEFT, 10, 10 );
    lv_obj_set_event_cb( exit_btn, exit_time_setup_event_cb );
    
    lv_obj_t *exit_label = lv_label_create( time_settings_tile, NULL);
    lv_obj_add_style( exit_label, LV_OBJ_PART_MAIN, &time_settings_heading_style  );
    lv_label_set_text( exit_label, "time settings");
    lv_obj_align( exit_label, time_settings_tile, LV_ALIGN_IN_TOP_MID, 0, 15 );
    ...
    lv_obj_align( wifisync_cont, time_settings_tile, LV_ALIGN_IN_TOP_RIGHT, 0, 55 );
    ...
    lv_obj_add_style( wifisync_onoff, LV_SWITCH_PART_KNOB, mainbar_get_knob_style() );
    ...
    lv_obj_add_style( clock_fmt_onoff, LV_SWITCH_PART_KNOB, mainbar_get_knob_style() );
    ...
    lv_obj_align( timezone_cont, clock_fmt_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 10 );
    lv_obj_t *timezone_label = lv_label_create( timezone_cont, NULL);
    lv_obj_add_style( timezone_label, LV_OBJ_PART_MAIN, &time_settings_heading_style  );
