...
lv_style_t bluetooth_settings_heading_style;
...
void bluetooth_settings_tile_setup( void ) {
    ...
    lv_style_copy( &bluetooth_settings_heading_style, &bluetooth_settings_style );
    lv_style_set_text_color( &bluetooth_settings_heading_style, LV_OBJ_PART_MAIN, LV_COLOR_WHITE );
    ...
    lv_obj_align( exit_btn, bluetooth_settings_tile, LV_ALIGN_IN_TOP_LEFT, 10, 10 );
    ...
    lv_obj_add_style( exit_label, LV_OBJ_PART_MAIN, &bluetooth_settings_heading_style  );
    lv_label_set_text( exit_label, "bluetooth settings");
    lv_obj_align( exit_label, bluetooth_settings_tile, LV_ALIGN_IN_TOP_MID, 0, 15 );
    ...
    lv_obj_align( bluetooth_enable_cont, bluetooth_settings_tile, LV_ALIGN_IN_TOP_RIGHT, 0, 55 );
    ...
    lv_obj_add_style( bluetooth_enable_onoff, LV_SWITCH_PART_KNOB, mainbar_get_knob_style() );
    ...
    lv_obj_align( bluetooth_standby_cont, bluetooth_enable_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 0 );
    ...
    lv_obj_add_style( bluetooth_standby_onoff, LV_SWITCH_PART_KNOB, mainbar_get_knob_style() );
    ...
    lv_obj_align( txpower_cont, bluetooth_standby_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 10 );    
