...
lv_style_t battery_view_heading_style;
lv_style_t battery_view_data_style;
...
void battery_view_tile_setup( uint32_t tile_num ) {
    ...
    lv_style_copy( &battery_view_heading_style, &battery_view_style );
    lv_style_set_text_color( &battery_view_heading_style, LV_OBJ_PART_MAIN, LV_COLOR_WHITE );

    lv_style_copy( &battery_view_data_style, &battery_view_style );
    lv_style_set_text_color( &battery_view_data_style, LV_OBJ_PART_MAIN, LV_COLOR_LIME );
    ...
    lv_obj_align( exit_btn, battery_view_tile, LV_ALIGN_IN_TOP_LEFT, 10, 10 );
    ...
    lv_obj_align( exit_label, battery_view_tile, LV_ALIGN_IN_TOP_MID, 0, 15 );
    ...
    lv_obj_align( battery_design_cont, battery_view_tile, LV_ALIGN_IN_TOP_RIGHT, 0, 55 );
    ...
    lv_obj_add_style( battery_view_design_cap, LV_OBJ_PART_MAIN, &battery_view_data_style  );
    ...
    lv_obj_align( battery_current_cont, battery_design_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 5 );
    ...
    lv_obj_add_style( battery_view_current_cap, LV_OBJ_PART_MAIN, &battery_view_data_style  );
    ...
    lv_obj_align( battery_voltage_cont, battery_current_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 5 );
    ...
    lv_obj_add_style( battery_view_voltage, LV_OBJ_PART_MAIN, &battery_view_data_style );
    ...
    lv_obj_add_style( charge_view_current, LV_OBJ_PART_MAIN, &battery_view_data_style );
    ...
    lv_obj_align( battery_discharge_cont, battery_charge_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 5 );
    ...
    lv_obj_add_style( discharge_view_current, LV_OBJ_PART_MAIN, &battery_view_data_style );
    ...
    lv_obj_align( vbus_voltage_cont, battery_discharge_cont, LV_ALIGN_OUT_BOTTOM_MID, 0, 5 );
    ...
    lv_obj_add_style( vbus_view_voltage, LV_OBJ_PART_MAIN, &battery_view_data_style );
